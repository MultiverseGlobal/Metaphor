...
@router.post("/chat")
async def chat_with_context(req: ContextRequest, consumer: Any = Depends(get_authorized_consumer), db: AsyncSession = Depends(get_session), _rate_limit: bool = Depends(llm_rate_limiter)):

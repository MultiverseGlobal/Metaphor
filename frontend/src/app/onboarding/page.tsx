...
const NotionIcon = () => (
  <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor">
    <path d="M4.459 4.208c-.742.062-1.026.31-1.228 1.102l-1.378 5.76c-.053.224-.131.62-.131.905 0 1.253.945 1.577 1.838 1.577 1.17 0 2.22-.387 3.018-1.042L16.273 6.94c.823-.67 1.527-1.125 2.502-1.125 1.484 0 2.457 1.055 2.457 2.66 0 1.17-.432 2.766-1.157 4.743l-1.638 4.41c-.247.66-.462 1.344-.462 1.942 0 .977.568 1.597 1.503 1.597 1.292 0 2.378-.813 3.125-1.921l.334-.486-.87-.417c-.367.545-.824.872-1.348.872-.514 0-.745-.346-.745-.905 0-.462.138-1.05.352-1.625l1.69-4.577c.804-2.17 1.332-4.11 1.332-5.59 0-2.316-1.576-3.805-3.83-3.805-1.513 0-2.61.64-3.64 1.488L6.084 10.3c-.567.457-1.166.724-1.743.724-.598 0-.913-.252-.913-.808 0-.325.074-.755.19-1.243l1.405-5.91c.147-.62.336-1.05.86-1.207L4.459 4.208z" />
  </svg>
);

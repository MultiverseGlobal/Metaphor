...
import { Shield, Activity, ExternalLink, Plus } from "lucide-react";
...
export default function ToolsPage() {
  const [tools] = useState<ConnectedTool[]>(TOOLS);
        ...
        {tools.map((tool) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 justify-between sm:justify-end">
              ...
              <button
                type="button"
                className="text-[12px] font-medium text-[#555E64] group-hover:text-[var(--color-ink)] hover:underline px-2 py-1 transition-colors"
              >
                Inspect
              </button>
            </div>

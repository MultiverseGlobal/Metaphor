...
export function EcosystemSwitcher() {
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      <button
        ...
        className={`p-1.5 rounded-lg border transition-all cursor-pointer ${
          isOpen
            ...
            : "bg-surface-1 hover:bg-surface-2 border-border-subtle text-muted hover:text-foreground"
        }`}
      ...
      {/* Waffle Popover Menu */}
      {isOpen && (
        <div className="absolute right-0 mt-3 w-80 rounded-2xl bg-surface-1 border border-border-strong p-4 shadow-2xl z-50 animate-in fade-in zoom-in-95 duration-150 space-y-3">
                ...
                <a
                  ...
                  className={`flex flex-col items-center text-center p-2.5 rounded-xl border transition-all group ${
                    isCurrent
                      ...
                      : "hover:bg-surface-2 border-transparent hover:border-border-subtle"
                  }`}
                >
                  <div 
          ...
          <div className="pt-2 border-t border-border-subtle text-center">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="text-[11px] font-mono text-muted hover:text-primary inline-flex items-center gap-1.5 transition-colors"
            >
